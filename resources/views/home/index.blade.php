                ...
                <div class="content-block">
                    ...
                    <div class="cb-content avatars">
                        <div class="row">
                            ...
                            <div class="col-lg-1 col-sm-2 col-xs-3"><a href="{{ route('categories.articles', $category->slug) }}"><img src="{{ $category->image == '/images/logo.png' ? '/images/logo.png' : '/storage/'.$category->image }}" alt=""><div class="note">{{ $category->name }}</div></a></div>
                            @endforeach                            
                        </div>
                    </div>
                </div>
                                ...
                                <div class="col-lg-3 col-sm-6 col-xs-12">
                                    <div class="h-video row">
                                        <div class="col-sm-12 col-xs-6">
                                            <div class="v-img">
                                                <a href="{{ route('articles.show', $article->slug) }}"><img src="{{ '/storage/'.$article->image }}" alt="{{ $article->title }}"></a>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-xs-6">
                                            <div class="v-desc">
