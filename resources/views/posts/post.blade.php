                ...
                <div class="list">
                    ...
                    <div class="h-video playlist row">
                        <div class="col-lg-5 col-sm-5 col-xs-6">
                            <div class="v-img">
                                <a href="{{ route('articles.show', $upSell->slug) }}" class="hvr-bob" onMouseover="afroHover.playclip()" onclick="afroClick.playclip()"><img src="{{ Voyager::image($upSell->thumbnail('cropped')) }}" alt="{{ $upSell->title }}"></a>
                            </div>
                        </div>
